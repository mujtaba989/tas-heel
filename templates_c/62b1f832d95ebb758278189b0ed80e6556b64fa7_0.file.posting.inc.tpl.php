<?php
/* Smarty version 3.1.30, created on 2018-08-02 14:28:23
  from "/opt/lampp/htdocs/follow-up/themes/default/subtemplates/posting.inc.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b62dcc70c97f1_67317254',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '62b1f832d95ebb758278189b0ed80e6556b64fa7' => 
    array (
      0 => '/opt/lampp/htdocs/follow-up/themes/default/subtemplates/posting.inc.tpl',
      1 => 1489283858,
      2 => 'file',
    ),
  ),
...
function content_5b62dcc70c97f1_67317254 (Smarty_Internal_Template $_smarty_tpl) {
...
<input id="name" type="text" size="40" name="name" value="<?php if ($_smarty_tpl->tpl_vars['name']->value) {
...
<input id="email" type="text" size="40" name="email" value="<?php if ($_smarty_tpl->tpl_vars['email']->value) {
...
<input id="hp" type="text" size="40" name="hp" value="<?php if ($_smarty_tpl->tpl_vars['hp']->value) {
...
<input id="location" type="text" size="40" name="location" value="<?php if ($_smarty_tpl->tpl_vars['location']->value) {
...
<input id="subject" type="text" size="50" name="subject" value="<?php if ($_smarty_tpl->tpl_vars['subject']->value) {
...
<?php }
if ($_smarty_tpl->tpl_vars['settings']->value['bbcode_flash']) {?>
<dt id="flash" title="<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'bbcode_flash_label');?>
"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'bbcode_flash_title');?>
</dt>
<dd><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'bbcode_flash_instruction');?>
</dd>
<?php }
if ($_smarty_tpl->tpl_vars['settings']->value['bbcode_tex']) {?>
...
<p><label for="captcha_code"><?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'captcha_expl_math');?>
 ...
 = </label><input id="captcha_code" type="text" name="captcha_code" value="" size="5" maxlength="5" tabindex="9" /></p>
<?php }?>
</fieldset>
<?php }?>
...
" tabindex="10" />&nbsp;<input type="submit" name="preview" value="<?php echo $_smarty_tpl->smarty->ext->configLoad->_getConfigVariable($_smarty_tpl, 'message_preview_button');?>
